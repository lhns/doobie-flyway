...
[![Maven Central](https://img.shields.io/maven-central/v/de.lolhens/doobie-flyway_2.13)](https://search.maven.org/artifact/de.lolhens/doobie-flyway_2.13)
...
### build.sbt
```sbt
libraryDependencies += "de.lolhens" %% "doobie-flyway" % "0.1.0"
```
